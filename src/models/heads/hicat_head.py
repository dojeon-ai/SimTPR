...
class HiCaTHead(BaseHead):
    ...
    def __init__(self, 
        ...
        ##########################
        # state transformer
        self.s_norm_in = nn.LayerNorm(proj_dim)
        ...
        self.s_norm_out = nn.LayerNorm(proj_dim)
        ...
        self.d_norm_in = nn.LayerNorm(proj_dim)
        self.d_decoder = Transformer(dim=proj_dim, 
                                     depth=num_layers, 
                                     heads=proj_dim//64, 
                                     mlp_dim=proj_dim*4, 
                                     dropout=dropout)
        self.d_norm_out = nn.LayerNorm(proj_dim)
        ...
        self.t_norm_in = nn.LayerNorm(proj_dim)
        self.t_decoder = Transformer(dim=proj_dim, 
                                     depth=num_layers, 
                                     heads=proj_dim//64, 
                                     mlp_dim=proj_dim*4, 
                                     dropout=dropout)
        self.t_norm_out = nn.LayerNorm(proj_dim)
