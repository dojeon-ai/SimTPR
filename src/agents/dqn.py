...
class DQN(BaseAgent):
    ...
    def __init__(self,
        ...
        self.epsilon_scheduler = self._build_eps_scheduler(cfg.eps_scheduler)
        self.optimizer = self._build_optimizer(cfg.optimizer)

    def _build_eps_scheduler(self, eps_cfg):
        return LinearScheduler(**eps_cfg)
